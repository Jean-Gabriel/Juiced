...
describe('Tokenizer', () => {
    it.each([
        ...
        ['>', TokenFixture.create(_ => _.atLine(1).withLexeme('>').nonLiteral(TokenKind.GREATHER_THAN))],
        ['>=', TokenFixture.create(_ => _.atLine(1).withLexeme('>=').nonLiteral(TokenKind.GREATHER_EQUAL))],
