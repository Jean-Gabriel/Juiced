...
import { NonLiteralTokenKind, NumberLiteralTokenKind, StringLiteralTokenKind, Token } from "../../../src/compiler/token/token";

export class TokenFixture {
    static create(consume: (fixture: TokenFixture) => Token) {
    ...
    withLiteral(literal: string | number | boolean) {
